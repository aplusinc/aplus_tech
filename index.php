...
<html lang="en-US">
	<head>
		...
		<meta name="title" content="APLUS TECH" />
		<meta name="description" content="Aplus Tech Is One Of The Leading Technology Blog From India Implemented With A Goal To Spread The Knowledge On Technology." />
						...
						<div class="panel-body" style="padding: 0px;">
							...
							<div class="col-sm-8">
								...
								<p><?php echo strip_tags($topcontent); ?>
									<a href="./articles_show.php/<?php echo $toppost['post_id'];?>">[.....]</a>
								</p>
							</div>
						</div>
					</div>
							...
							<div class="col-sm-2" style="padding: 0px;">
								<div class="panel panel-default wow fadeInUp">
									<div class="panel-body" style="padding: 0px;">
										...
										<a href="./articles_show.php/<?php echo $trend[2]['post_id']; ?>"><p class="shead"><?php echo substr($trend[2]['post_heading'],0,25);?></p></a>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-2" style="padding: 0px;">
								<div class="panel panel-default wow fadeInDown">
									<div class="panel-body" style="padding: 0px;">
										...
										<a href="./articles_show.php/<?php echo $trend[3]['post_id']; ?>"><p class="shead"><?php echo substr($trend[3]['post_heading'],0,25);?></p></a>
									</div>
								</div>
							</div>
							<div class="col-sm-1" style="padding: 0px;"></div>
							<div class="col-sm-2" style="padding: 0px;">
								<div class="panel panel-default wow fadeInUp">
									<div class="panel-body" style="padding: 0px;">
										...
										<a href="./articles_show.php/<?php echo $trend[4]['post_id']; ?>"><p class="shead"><?php echo substr($trend[4]['post_heading'],0,25);?></p></a>
									</div>
								</div>
							</div>
							<div class="col-sm-1" style="padding: 0px;"></div>
							<div class="col-sm-2" style="padding: 0px;">
								<div class="panel panel-default wow fadeInDown">
									<div class="panel-body" style="padding: 0px;">
										...
										<a href="./articles_show.php/<?php echo $trend[5]['post_id']; ?>"><p class="shead"><?php echo substr($trend[5]['post_heading'],0,25);?></p></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-default" style="margin-top: 54px;padding-bottom: 10px;">
						<div class="panel-body">
							<a href="http://aplusinc.github.io">
								...
								<img src="http://aplusinc.github.io/images/logo.png" class="img-responsive">
							</a>
							<p>
