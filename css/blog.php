<?php
	...
	$page=new blog();
	$rank= $page->ranks();
	$headings = $page->headings($pageLimit,$setLimit);
	if(count($headings) < 1){
	...
	$paginate = $page->displayPaginationBelow($setLimit,$item);
		...
		<div class="container-fluid" style="padding-top: 80px;background-color: rgba(255,255,255,0.4);">
			<div class="row">
				<div class="col-md-8">
					...
					<a href="./articles_show.php?id=<?php echo $headings[$i]['post_id']; ?>">
					<div class="panel panel-default wow fadeInLeft" data-wow-delay=".<?php echo $i+1;?>s">
						<div class="panel-body head">
							<span class="number"><?php echo $i+1; ?></span>&nbsp;&nbsp;&nbsp;<span class="title"><?php echo $headings[$i]['post_heading']; ?></span><span class="pull-right tag">#<?php echo $headings[$i]['post_categories']; ?></span>
						</div>
					</div>
					</a>
					<?php $i++; } ?>
				...
				<div class="col-md-2 text-center">
					...
					<div class="panel panel-default" style="margin-top: 20px;">
						<div class="panel-body rank-two" style="text-transform: uppercase;">
							<a href="articles_show.php?id=<?php echo $toppost['post_id']; ?>" style="color: yellow;"><?php echo $toppost['post_heading']; ?></a>
						</div>
					</div>
				</div>
				<div class="col-md-1"></div>
